          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  Get personalized recommendations and insights from our AI fitness expert
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <iframe 
                ...
                title="LiftLink AI Fitness Insights"
              />
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ margin: 0, fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>
                  Get insights on your fitness journey
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{ margin: 0, fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>
                  Track improvements and patterns
                </p>
              </div>
            </div>
          </div>
